        ...
        <tr>
          ...
          <table class="table table-bordered">
					<tr class="other1">
						...
						<td class="span1">
							<img class="add_budget_other_1" src="themes/fundv2/images/btn_add.png" style="cursor: pointer;">
						</td>
					</tr>
					...
					<tr class="other2">
						...
						<td class="span1">
							<img class="add_budget_other_2" src="themes/fundv2/images/btn_add.png" style="cursor: pointer;">
						</td>
					</tr>
					...
					<tr class="other3">
							...
							<td class="span1">
								<img class="add_budget_other_3" src="themes/fundv2/images/btn_add.png" style="cursor: pointer;">
							</td>
						</tr>
				</table>
				...
				<table class="table table-bordered">
					<tr class="other4">
						...
						<td class="span1">
							<img class="add_budget_other_4" src="themes/fundv2/images/btn_add.png" style="cursor: pointer;">
						</td>
					</tr>
				</table>
